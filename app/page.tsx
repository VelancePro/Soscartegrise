        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-10">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-gray-900 text-white font-titre font-semibold px-7 py-3.5 rounded-full hover:bg-gray-700 transition-colors duration-200 shadow-md"
            >
